...
class TestModel:
    def __init__(self):
        ...
        self.RAW_IMAGES = "reecho/data/lfw"
        self.X = None
        self.X_G = None
    ...
    def ImageReconstruction(self):
        normal_autoencoder = VAE.load("reecho/normal-model")
        ...
        plot_reconstructed_images(sample_images, reconstructed_images, 'reecho/test/exported-data/original-reconstructed', 'original-reconstructed.png', True)
        
    def NoiseReduction(self):
        noisefilter_autoencoder = VAE.load("reecho/noisefilter-model")
        ...
        plot_reconstructed_images(sample_images, reconstructed_images, 'reecho/test/exported-data/noisefilter', 'original-reconstructed.png', True,)
        
    
    def NewImageGeneration(self):
        addingimage_autoencoder = VAE.load("reecho/normal-model")
        image1 = []
        ...
        plot_add_image(image1[0], image2[0], reconstructed_images[0], 'reecho/test/exported-data/generate_image', 'generate_image.png')
        
    def ColoringImage(self):
        colorimage_autoencoder = VAE.load("reecho/normal-model")
        num_sample_images_to_show = 5
        ...
        plot_reconstructed_images(sample_images, reconstructed_images, 'reecho/test/exported-data/colorimage', 'colorimage.png', True,)
